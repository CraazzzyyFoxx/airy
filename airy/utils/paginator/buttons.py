...
class NavButton(Button[AiryPagesT]):
...
class PrevButton(NavButton[AiryPagesT]):
    """
...
class FirstButton(NavButton[AiryPagesT]):
    """
...
class LastButton(NavButton[AiryPagesT]):
    """
...
class IndicatorButton(NavButton[AiryPagesT]):
    """
...
class StopButton(NavButton[AiryPagesT]):
    """
